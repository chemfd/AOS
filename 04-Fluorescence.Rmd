...
```{r echo=FALSE, FRET, out.width='40%', fig.show='hold', fig.align='center', fig.cap='The absorbance and emission of a donor and acceptor with the highlighted region being the spectral overlap integral which allows for energy transfer between the two species.'}
