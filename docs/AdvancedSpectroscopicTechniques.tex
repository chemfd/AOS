...
\chapter{Fluorescence Lifetime}\label{ch:fluorlif}}
...
You will already be familiar with the fluorescence, and how emission from an excited state is a spontaneous process following first order kinetics.
