...
```{r echo=FALSE,TAsetup, out.width='60%', fig.show='hold', fig.align='center', fig.cap='Flash photolysis gives kinetic profiles which either show the formation and decay of an excited state (top) or bleach and recovery of a ground state (bottom).'}
knitr::include_graphics("images/TA.setup.png")
```
